...
test "sqlite schema is loaded from the canonical install file" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, schema, "CREATE TABLE IF NOT EXISTS structured_import_provenance") != null);
    ...
    try std.testing.expect(std.mem.indexOf(u8, schema, "CREATE TABLE IF NOT EXISTS mindbrain_answer_artifacts") != null);
    try std.testing.expect(std.mem.indexOf(u8, schema, "CREATE TABLE IF NOT EXISTS mindbrain_answer_events") != null);
...
test "sqlite schema includes the collection raw tables" {
    ...
    try std.testing.expect(std.mem.indexOf(u8, schema, "CREATE TABLE IF NOT EXISTS ontology_triples_raw") != null);
