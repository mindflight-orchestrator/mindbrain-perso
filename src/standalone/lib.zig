...
pub const graph_pattern = @import("graph_pattern.zig");
pub const graph_pattern_bridge = @import("graph_pattern_bridge.zig");
...
pub const structured_import = @import("structured_import.zig");
pub const structured_import_ddl = @import("structured_import_ddl.zig");
